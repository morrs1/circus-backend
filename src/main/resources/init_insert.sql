...
INSERT INTO tickets_sale ( purchase_date, payment_type, viewer_num)
VALUES ('2023-09-25', 'Кредитная карта', 1),
       ('2023-09-26', 'Наличные', 2),
       ('2023-09-27', 'Электронный кошелек', 3),
       ('2023-09-28', 'Кредитная карта', 4),
       ('2023-09-29', 'Наличные', 5);
